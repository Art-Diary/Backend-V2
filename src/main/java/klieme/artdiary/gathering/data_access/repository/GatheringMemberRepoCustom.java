...
public interface GatheringMemberRepoCustom {
	...
	List<Map<String, Object>> getGatheringMateListForSearch(Long gatheringId, Long userId, String nickname);

	List<UserEntity> getGatheringMateList(Long gatheringId);
}
